...
public class ClientMain {
	...
	public static void main(String[] args) {
		...
		PizzaChain pc = new PizzaChain("Special");
		pc = pc.setChainTomatoes(true).setChainPepperoni(true);

		// the alternative
		// Pizza p0 = new Pizza("Pineroni", true, false, ...
		...
		// here we use a specific builder
